...
const octokit_2 = require("./octokit");
let installationAccessToken;
exports.installationAccessToken = installationAccessToken;
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            exports.installationAccessToken = installationAccessToken = yield octokit_1.setInstallationAccessToken();
            ...
            yield octokit_2.octokit.issues.create({
